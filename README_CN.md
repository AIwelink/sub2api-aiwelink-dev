...
**为开发者与团队提供统一、稳定的主流 AI 模型访问服务。**

**[访问 AIwelink API](https://api.aiwelink.cc)**
...
AIwelink API 是基于 Sub2API 代码库构建的多模型 AI API 网关与管理服务。用户通过平台生成的 API Key 调用上游 AI 服务，平台负责鉴权、计费、负载均衡和请求转发。
