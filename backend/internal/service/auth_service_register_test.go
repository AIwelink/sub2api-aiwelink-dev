...
type authGrowthRegistrationRecorderStub struct {
	contexts []context.Context
	users    []*User
	err      error
}

func (r *authGrowthRegistrationRecorderStub) RecordSuccessfulRegistration(ctx context.Context, user *User) error {
