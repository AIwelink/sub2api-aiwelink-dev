...
func TestContentModerationCallRoutesThroughProxy(t *testing.T) {
	...
	svc := newContentModerationTestService(nil, nil, nil, nil, nil, proxyRepo, nil, nil)
...
func TestContentModerationUpdateConfigProxyIDSemantics(t *testing.T) {
	...
	svc := newContentModerationTestService(settingRepo, nil, nil, nil, nil, proxyRepo, nil, nil)
