    ...
    <div class="flex h-full items-center justify-between gap-2 px-2 sm:px-4 md:px-6">
      ...
      <div class="flex shrink-0 items-center gap-2 sm:gap-4">
        <button
          ...
          class="workbench-header-action lg:hidden"
        ...
        <div class="min-w-0">
          <h1 class="truncate text-sm font-semibold text-theme-text sm:text-base">
            {{ pageTitle }}
          </h1>
          <p v-if="pageDescription" class="hidden truncate text-[11px] text-theme-muted lg:block">
            {{ pageDescription }}
          </p>
        </div>
      </div>
      ...
      <div class="flex min-w-0 items-center gap-1 sm:gap-3">
        ...
        <a
          ...
          class="workbench-header-action hidden sm:flex"
        >
        ...
        <div
          v-if="user"
          class="workbench-balance group relative hidden items-center gap-2 sm:flex"
        >
          <svg
            class="h-4 w-4 text-[rgb(var(--workbench-accent-gold))]"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
            stroke-width="1.5"
          ...
          <span class="font-mono text-xs font-semibold text-[rgb(var(--workbench-accent-gold))]">
            {{ formatHeaderMoney(availableBalance) }}
          </span>
          <span
            v-if="frozenBalance > 0"
            class="text-[10px] font-medium text-amber-700 dark:text-amber-200"
          >
            {{ balanceFrozenLabel }}
          </span>
          <div
        ...
        <div v-if="user" class="relative" ref="dropdownRef">
          <button
            ...
            class="workbench-user-trigger"
            :aria-label="t('common.userMenu')"
          >
            <div class="flex h-8 w-8 items-center justify-center overflow-hidden rounded-full border border-[rgb(var(--workbench-border-strong))] bg-[rgb(var(--workbench-surface-hover))] text-xs font-semibold text-theme-text">
              <img
                v-if="avatarUrl"
                :src="avatarUrl"
                :alt="displayName"
            ...
            <div v-if="dropdownOpen" class="dropdown right-0 mt-2 w-56">
              ...
              <div class="py-1">
                ...
                <a
                  ...
                  href="https://github.com/AIwelink/sub2api-aiwelink-dev"
                  target="_blank"
                  rel="noopener noreferrer"
                  @click="closeDropdown"
                  class="dropdown-item"
